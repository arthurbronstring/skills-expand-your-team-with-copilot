document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    // Apply client-side filtering - this handles category filter and search, plus weekend filter and difficulty
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      // "All Levels" (empty currentDifficulty) should only show activities with no difficulty specified
